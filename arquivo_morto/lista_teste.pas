...
begin
  ...
  while (op <> 0) do begin
      ...
      if (op = 1 ) then begin
        ...
        read(valor);
        writeln('Valor removido: ', removerValorDaLista(valor, lista1));
      end else if (op = 4) then begin
        escreverLista(lista1);
      end else if (op = 5) then begin
        read(valorInt);
        writeln('Valor na posicao ', valorInt, ' = ', recuperarValorListaPorPosicao(valorInt, lista1));
      end;
  end;
